...
import Register from "@/app/create-team/components/register"

export default function CreateTeam() {
    const isTournamentActive = true;
  
    return (
      <div className="min-h-screen pt-16 flex flex-col items-center"> {/* Add padding-top to account for Navbar */}
